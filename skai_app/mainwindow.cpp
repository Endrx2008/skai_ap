      ...
      sendButton(nullptr)
{
    ...
    input_text->setPlaceholderText("Chat with skai...");
...
{
    QString color = (sender == "User") ? "#569CD6" : "#CE9178";
...
void MainWindow::onSendClicked()
{
    ...
    QString modelResponse = userInput;
    appendMessage("Skai", modelResponse);
